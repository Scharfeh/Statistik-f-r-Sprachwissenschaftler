...
# Nein, es kann auch mehrere Modalwerte geben (2 oder mehr). Diese können gleich oft auftreten und so den Modus bilden.
# Wenn diese Annahme zutrifft, dann ist der genannte Code nicht korrekt. Hier wird nur der erste Wert abgefragt,
# der zuerst und am häufigsten in einer Reihe erscheint. Es wird hingegen nicht geprüft, ob nachfolgende Werte den gleichen Wert haben.
