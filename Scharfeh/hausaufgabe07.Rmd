...
Bei den beiden Notenblöcken wird deutlich, dass bei einer geringen SD (z.B. 3) der prozentuale Anteil der Schüler, der schlechte Noten hat, größer ist als der Anteil, der gute Noten hat. 
Warum?
Es werden weniger gute Noten als schlechte Noten betrachtet.
...
Der kritische Wert für einen einseitigen $z$-Test ist (für Alpha=0,06) `r qnorm(0.94)` (für Alpha=0,05) `r qnorm(0.95)`.

Die kritischen Werte für einen zweiseitigen $z$-Test sind $\pm$`(für Aplha=0,06) $\pm$ `r qnorm(0.97)` (für Alpha=0,05) $\pm$ `r qnorm(0.975)`.
